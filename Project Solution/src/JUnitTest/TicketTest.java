...
public class TicketTest {
	...
	public void setUp() throws Exception {
		t=new Ticket(0,new Seat("testTheatre",1,1),new Projection(0, 0.0, 0, 0, "no name","no date","no time"),new Customer (0,"initilaze"));
	}
	...
	public void test_settCustomError() {
		...
		t.settCustomError(c);
		assertSame(c,t.gettCustomError());
	}
}
