...
public class OrdersQController {		
	...
	static OrdersDbApi dpApiRef = new OrdersDbApi();
	
	public static void showTickets(int projectionID) {
	...
	public static ArrayList<String> getAllProjectionAvilableTime(String mname, String date)
	{
