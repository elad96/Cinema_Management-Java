...
public class MainFrame extends JFrame {
	...
	public MainFrame() {
		...
		layeredPane.add(panelFinance); // "name_1384295830222900"
		...
		btnFinanceShowCandleData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (textFieldFinanceFromDate.getText() != null && textFieldFinanceToDate.getText() != null) {
					tableFinanceByDate.setModel(FinanceQController.earnedByTime(textFieldFinanceFromDate.getText(),
							textFieldFinanceToDate.getText()));
		...
		layeredPane.add(panelOperations);// "name_1384302948344900"
		...
		btnOperationsConfirmMovie.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (textFieldOperationsYearPublished.getText() != null && textFieldOperationsMovieName.getText() != null
						&& textFieldOperationsMovieDirector.getText() != null
						&& textFieldOperationsMovieDuration.getText() != null
						&& textFieldOperationsMovieDescription.getText() != null) {
					...
					try {
						...
						directorString = InputVerifacator.verifyNameString("Director Name",
		...
		btnOperationsProjectionConfirm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (comboBoxOperationsProjectionMovie.getSelectedItem() != null
						&& textFieldOperationsProjectionTicketPrice.getText() != null
						&& comboBoxOperationsProjectionTheater.getSelectedItem() != null
						&& textFieldOperationsProjectionDate.getText() != null
						&& textFieldOperationsProjectionTime != null) {
					try {
		...
		layeredPane.add(panelOrders);// "name_1384306055576300"
		...
		// event to select movie which update dates
		...
		comboBoxOrdersDate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (comboBoxOrdersDate.getSelectedItem() != null) {
					ArrayList<String> availableTime = OrdersQController.getAllProjectionAvilableTime(
				...
				if (comboBoxOrdersDate.getSelectedItem() != null && comboBoxOrdersTime.getSelectedItem() != null) {
					...
					for (int i = 0; i < THEATRE_ROW; i++) {
						for (int j = 0; j < THEATRE_COL; j++) {
							seatsBtnArr[i][j] = new seatCustomBtn(textFieldOrdersTheatre.getText(), i, j);
							seatsBtnArr[i][j]
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					if (OrdersQController.determineIfSeatIsTaken(pidInteger, rowInteger, colInteger)) {
						...
						String customerNameString = InputVerifacator.verifyNameString("Customer Name",
